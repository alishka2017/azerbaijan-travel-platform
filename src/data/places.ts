...
export const cities: City[] = [
  ...
  },
  {
    ...
    population: "20,000",
    description: "Gateway to Shahdag Mountain Resort, known for its stunning natural landscapes and ski slopes.",
    ...
    transport: "Car, bus",
    topAttractions: ["Shahdag Mountain Resort", "Laza Waterfalls"],
    topRestaurants: ["Mountain View Restaurant"],
    topHotels: ["Shahdag Hotel & Spa"]
  },
  {
    id: "sheki",
    name: "Sheki",
    ...
    population: "65,000",
    description: "Historic city in the Caucasus mountains, famous for its UNESCO-listed Khan Palace and silk production.",
    ...
    transport: "Bus, car",
    topAttractions: ["Sheki Khan Palace", "Caravanserai"],
    topRestaurants: ["Sheki Saray", "Piti House"],
    topHotels: ["Sheki Karvansaray Hotel"]
  },
  {
    id: "gabala",
    name: "Gabala",
    ...
    population: "15,000",
    description: "Mountain resort town known for Tufandag Mountain Resort and beautiful nature.",
    ...
    transport: "Bus, car",
    topAttractions: ["Tufandag Mountain Resort", "Nohur Lake"],
    topRestaurants: ["Gabala Restaurant", "Mountain View"],
    topHotels: ["Rixos Gabala", "Qafqaz Resort"]
  },
  {
    id: "lankaran",
    name: "Lankaran",
    ...
    population: "85,000",
    description: "Coastal city on the Caspian Sea, known for its tea plantations and tropical climate.",
    heroImage: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/29/Lankaran_2021.jpg/1280px-Lankaran_2021.jpg",
    bestTime: "May-September",
    distanceFromBaku: "220 km",
    transport: "Bus, car",
    topAttractions: ["Lankaran Fortress", "Girdiman River"],
    topRestaurants: ["Lankaran Tea House", "Caspian Fish Restaurant"],
    topHotels: ["Lankaran Resort & Spa"]
  }
];
